...
>
> First numbered version: **0.1a1** (2026-05-20). Latest release: **[v0.6.1 — small-response fix](https://github.com/mplsllc/macsurf/releases/latest)** (2026-05-25). Full notes: [docs/release-notes/MacSurf-0.6.1.md](docs/release-notes/MacSurf-0.6.1.md).
...
Latest release: **[MacSurf v0.6.1 — small-response fix](https://github.com/mplsllc/macsurf/releases/tag/v0.6.1)** (2026-05-25, HTTPS small-response fix on top of v0.6's native TLS). Previous: [v0.6](https://github.com/mplsllc/macsurf/releases/tag/v0.6), [v0.5.0](https://github.com/mplsllc/macsurf/releases/tag/v0.5.0), [v0.1a1](https://github.com/mplsllc/macsurf/releases/tag/v0.1a1).

- **[MacSurf.sit](https://github.com/mplsllc/macsurf/releases/download/v0.6.1/MacSurf.sit)** (latest binary, v0.6.1), ready-to-run. Expand on Mac OS 9.1+ with CarbonLib 1.5+ and launch.
